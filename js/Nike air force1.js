...
function opcao1(){
    img1="img/air force img1 branco.avif"
    img2="img/air force img2 branco.avif"
    img3="img/air force img3 branco.avif"
    p="799,90"
    n="Cor: branco"
  ...
  function addf(){
        ...
        mensagem("Selecione um tamanho para continuar.")
         setTimeout(()=>{  mensagem("")},3000)
                ...
                let textc= "Air force 1 "+ document.getElementById("nome").textContent+" "+tamanhos
