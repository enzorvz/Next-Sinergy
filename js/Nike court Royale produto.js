...
function opcao1(){
    img1="img/court royale 2.avif"
    img2="img/court royale 2 img2.avif"
    img3="img/court royale 2 img3.avif"
    p="439,99"
    n="Cor: Preto"
...
function opcao2(){
    img1="img/court royale 2 img1 branco com preto.avif"
     img2="img/court royale 2 img2 branco com preto.avif"
    img3="img/court royale 2 img3 branco com preto.avif"
    p="489,90"
    n="Cor: Branco/preto"
    opcao(img1,img2,img3,n)
...
function opcao3(){
    ...
    img1="img/court royale 2 img1 branco.avif"
    img2="img/court royale 2 img2 branco.avif"
     img3="img/court royale 2 img3 branco.avif"
    p="489,90"
    n="Cor: Branco"
    opcao(img1,img2,img3,n)
}
      ...
      //  if (7>su) {
        ...
        mensagem("Selecione um tamanho para continuar.")
         setTimeout(()=>{  mensagem("")},3000)
                ...
                let textc= "Court Royale 2 - masculino "+ document.getElementById("nome").textContent+" "+tamanhos
